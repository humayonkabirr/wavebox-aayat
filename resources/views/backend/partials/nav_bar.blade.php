        ...
        <ul class="navbar-item flex-row ml-md-auto">
            ...
            <li class="nav-item dropdown language-dropdown">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ asset('admin/assets/img/ca.png') }}"
                    ...
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{ asset('amdin/assets/img/ca.png') }}"
                            class="flag-width" alt="flag"> <span
            ...
            <ul class="navbar-nav flex-row ml-auto ">
                <li class="nav-item more-dropdown">
                    <div class="dropdown  custom-dropdown-icon">
                        <button class="btn btn-outline-success"  data-toggle="modal" data-target="#exampleModalCenter">Add Demo</button>
                    </div>
                </li>
            </ul>
        </header>
