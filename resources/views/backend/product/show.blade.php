                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="forImageOne" id="forImageOne" class="form-control" rows="13"  placeholder="Enter for image one">{{ old('title', $product->details ?? '') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="forImageTwo" id="forImageTwo" class="form-control" rows="13"  placeholder="Enter for image Two">{{ old('title', $product->details ?? '') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <textarea name="forImageThree" id="forImageThree" class="form-control" rows="13"  placeholder="Enter for image Three">{{ old('title', $product->details ?? '') }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
